# -*- coding: utf-8 -*-
"""
- Napisz klasę Kwadrat, Trójkąt, które są sub klasami klasy Wielokąt
- Klasa Wielokąt ma zawierać
    -Metodę askNSides(), która pyta użytkownika o ilość boków wielokąta (która się przyda tylko, gdy wywołamy obiekt
    poprzez klasę Wielokąt)
...
- Klasa Trójkąt ma zwierać:
    ...
    -Metoda isRight(), która sprawdza, czy trójkąt jest prostokątny
